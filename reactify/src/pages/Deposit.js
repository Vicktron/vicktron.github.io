              ...
              <div class="main__content">
                ...
                >
                  <fieldset class="group">
                    <p class="legen legen__active">Balance</p>
                    <div
                      ...
                      <div class="row">
                        <div class="col-md-6 col-lg-3">
                          <div class="payment__system__checkbox__single">
                            <label for="StakerCity" class="check_wrap">
                              <input
                                type="checkbox"
                        ...
                        <div class="col-lg-6">
                          <div class="checkbox__investment__plan">
                            <label for="spo-10" class="check_wrap_plan">
                              <input
                                type="checkbox"
                                class="pay__system__check__plan"
                                id="spo-10"
                              />
                              <span class="checkmark"></span>
                            </label>
                            ...
                            <div class="investment__item">
                              <div class="investment__item__inner">
                                ...
                                >
                                  ...
                                  <hr />
                                  <h4 class="text-center content__space--small">
                                    5%
                                  </h4>
                                  <p class="text-center">Monthly</p>
                                  <hr />
                  ...
                  <fieldset class="group">
                    ...
                    <div
                      class="payment__system__checkbox__wrapper payment__system__amount"
                    >
                      ...
                      <div class="row cta__space">
                        <div class="col-lg-7">
                          <div class="daily-profit column__space">
                            <p class="secondary content__space--smalll">
                              Daily Profit
                            </p>
                            <h3><span id="dailyProfit"></span> $TAKER</h3>
                          </div>
                        </div>
                        <div class="col-lg-5">
                          <div class="total-profit column__space">
                            ...
                            <h3><span id="totalProfit"></span> $TAKER</h3>
                          </div>
                        </div>
                      </div>
                      <div class="slide__group column__space">
                        <div class="output d-flex">
                          <span class="range__output__value">Balance 296</span>
                          <span>$TAKER</span>
                        </div>
                        <input
                          class="range__slider"
            ...
            <div class="col-lg-8">
              <div class="footer__credit__left">
                <p class="text-center text-lg-start">
                  Copyright © <a href="deposit.html#0">StakerCity</a> | Designed
                  by
                  <a href="">Victhereum</a>
                </p>
              </div>
