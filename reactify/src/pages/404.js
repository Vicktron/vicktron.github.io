...
<html lang="en-US">
  <head>
    ...
    />
    <!-- #title -->
    <title>StakerCity &dash; Crypto Investment With StakerCity</title>
    <!-- #keywords -->
    <meta
      name="keywords"
    ...
    <!-- #author -->
    <meta name="author" content="Victhereum" />
  ...
  <body>
    <!-- ==== error section start ==== -->
    <section
      class="error section__space bg__img"
      data-background="./assets/images/error-bg.png"
    >
      <div class="container">
        <div class="error__area text-center">
          <img
          ...
          <div class="error__content">
            <h3 class="content__space">Page Not Found</h3>
            <h4 class="cta__space">Oops.. looks like you got lost</h4>
