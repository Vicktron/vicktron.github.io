                      ...
                      <div class="balance__single column__space">
                        ...
                        <div class="balance__content">
                          ...
                          <div class="last__action">
                            <p class="tertiary">Staked Amount:</p>
                            <p class="tertiary">$TAKER 100.00</p>
                          </div>
                          <a href="deposit.html" class="button">New Deposit</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="balance__single balance__alt__content">
                        ...
                        <div class="balance__content">
                          ...
                          <h5>$TAKER 800.00</h5>
                          <div class="last__action">
                            <p class="tertiary">Current Plan:</p>
                            <p class="tertiary">Investor</p>
                          </div>
                          <a href="withdrawal.html" class="button"
                            >Withdraw Funds</a
                          >
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-lg-8">
                      <div class="affiliate__link column__space">
                        ...
                        <div class="copy">
                          <p id="copy-el">https://stakecity.io/?ref=0x7gb...08fr</p>
                          <button id="el-copied" onclick="copyEl()" class="button"
                            ><em class="fas fa-copy"></em></button
                          >
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 col-lg-4">
                      <div class="level__single column__space">
                        <a href="dashboard.html#" class="button">Direct</a>
                        <p>0</p>
                        <p class="tertiary">Partners</p>
                        <hr />
                        <h5>$0.00</h5>
                    ...
                    <div class="col-md-6 col-lg-4">
                      <div class="level__single column__space">
                        <a href="dashboard.html#" class="button">Level 2</a>
                        <p>0</p>
                        <p class="tertiary">Partners</p>
                        <hr />
                        <h5>$0.00</h5>
                    ...
                    <div class="col-md-6 col-lg-4">
                      <div class="level__single">
                        <a href="dashboard.html#" class="button">Level 3</a>
                        <p>0 / 0</p>
                        <p class="tertiary">Partners</p>
                        <hr />
                        <h5>$0.00</h5>
            ...
            <div class="col-lg-8">
              <div class="footer__credit__left">
                <p class="text-center text-lg-start">
                  Copyright © <a href="dashboard.html#0">StakerCity</a> |
                  Designed by
                  <a href="">Victhereum</a>
                </p>
              </div>
